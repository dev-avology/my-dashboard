          ...
          <div className="py-2">
            ...
            <form
              ...
              <div className="mb-5 px-4">
               ...
               formState.status === "field-errors" && !!formState.errors.description ? 'border-red-500' : ''  }`} placeholder="" autoFocus defaultValue={formState.form.description}  />
              </div>
              <div className="mb-5 px-4">
