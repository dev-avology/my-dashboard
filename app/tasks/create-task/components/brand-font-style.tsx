...
interface BrandFontStyleProps {

}

const BrandFontStyle: React.FC<BrandFontStyleProps> = () => {
    ...
    >
        <div className="h-full  pt-4 overflow-y-auto  relative pb-[110px]">
            <div>
                <p className="text-base text-gray-500">Upload your Brand Font family </p>
            </div>
            <div className="mt-5  relative left-0 right-0 text-base text-gray-500" >
                ...
                <div>
                    ...
                    <div className="mb-3">
                        ...
                        <div className="grid grid-cols-10 gap-2 grid-flow-row mt-4  ">
