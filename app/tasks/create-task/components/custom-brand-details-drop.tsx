...
import { Brandprofiles } from "@/use-cases/global-data";

interface CustomBrandDrawerDropProps {
    formRef: React.RefObject<HTMLFormElement>;
}

const CustomBrandDrawerDrop: React.FC<CustomBrandDrawerDropProps> = ({ formRef}) => {


    const CurrentBrandProfile = Brandprofiles.find((profile)=>profile.label === 'Create Custom Profile');
...
export default CustomBrandDrawerDrop;